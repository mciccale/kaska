...
int main(int argc, char *argv[]) {
    ...
    // del mismo, que tiene como clave un string, hay una cola.

    // se trata de una colección de cuentas bancarias, tal que cada cuenta
    // tiene asociado el nombre del titular, su edad, el saldo y una
    // cola de operaciones, incluyendo cada operación la cantidad y la fecha;
    ...
    // EN LA PRÁCTICA CREAREMOS UN MAPA EN LA INICIALIZACIÓN DEL BROKER
    // Y OTRO EN LA BIBLIOTECA DE CLIENTE PARA ALMACENAR LAS SUSCRIPCIONES.
    // EN AMBOS MAPAS EL NOMBRE DEL TEMA ACTUARÁ DE CLAVE. NÓTESE QUE EL
    // PRIMER MAPA SE ACCEDERÁ DESDE MÚLTIPLES THREADS
